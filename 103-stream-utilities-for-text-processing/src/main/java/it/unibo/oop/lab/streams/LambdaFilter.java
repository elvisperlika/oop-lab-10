...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        ...
        COUNTCHARS("count chars", t -> Long.toString(t.chars().count())),
        COUNTLINES("count lines", t -> Long.toString(t.lines().count())),
        ORDERWORDS("order the words", t -> Arrays.stream(t.split(" "))
            .sorted()
            .collect(Collectors.joining("\n"))),
        COUNTWORDS("count every words", t -> Arrays.stream(t.split(" "))
